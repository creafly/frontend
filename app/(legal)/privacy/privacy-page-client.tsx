		...
		<div className="min-h-screen bg-background">
			<Container className="py-12">
				...
				<TypographyArticle>
					...
					<TypographyH2 margin="default">{t.legal.privacyCollectTitle}</TypographyH2>
					...
					<TypographyH2 margin="default">{t.legal.privacyAutoCollectTitle}</TypographyH2>
					...
					<TypographyH2 margin="default">{t.legal.privacyUseTitle}</TypographyH2>
					...
					<TypographyH2 margin="default">{t.legal.privacySharingTitle}</TypographyH2>
					...
					<TypographyH2 margin="default">{t.legal.privacySecurityTitle}</TypographyH2>
					<TypographyP>{t.legal.privacySecurityText}</TypographyP>

					<TypographyH2 margin="default">{t.legal.privacyRetentionTitle}</TypographyH2>
					<TypographyP>{t.legal.privacyRetentionText}</TypographyP>

					<TypographyH2 margin="default">{t.legal.privacyRightsTitle}</TypographyH2>
					...
					<TypographyH2 margin="default">{t.legal.privacyCookiesTitle}</TypographyH2>
					<TypographyP>{t.legal.privacyCookiesText}</TypographyP>

					<TypographyH2 margin="default">{t.legal.privacyTransfersTitle}</TypographyH2>
					<TypographyP>{t.legal.privacyTransfersText}</TypographyP>

					<TypographyH2 margin="default">{t.legal.privacyChildrenTitle}</TypographyH2>
					<TypographyP>{t.legal.privacyChildrenText}</TypographyP>

					<TypographyH2 margin="default">{t.legal.privacyChangesTitle}</TypographyH2>
					<TypographyP>{t.legal.privacyChangesText}</TypographyP>

					<TypographyH2 margin="default">{t.legal.privacyContactTitle}</TypographyH2>
					<TypographyP>
					...
					<TypographyH2 margin="default">{t.legal.privacyRelatedTitle}</TypographyH2>
					<TypographyP>
