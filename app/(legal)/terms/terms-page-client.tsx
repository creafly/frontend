		...
		<div className="min-h-screen bg-background">
			<Container className="py-12">
				...
				<TypographyArticle>
					...
					<TypographyH2 margin="default">{t.legal.termsAcceptanceTitle}</TypographyH2>
					<TypographyP>{t.legal.termsAcceptanceText}</TypographyP>

					<TypographyH2 margin="default">{t.legal.termsDescriptionTitle}</TypographyH2>
					<TypographyP>{t.legal.termsDescriptionText}</TypographyP>

					<TypographyH2 margin="default">{t.legal.termsAccountsTitle}</TypographyH2>
					<TypographyP>{t.legal.termsAccountsText}</TypographyP>

					<TypographyH2 margin="default">{t.legal.termsAcceptableUseTitle}</TypographyH2>
					...
					<TypographyH2 margin="default">{t.legal.termsIPTitle}</TypographyH2>
					<TypographyP>{t.legal.termsIPText}</TypographyP>

					<TypographyH2 margin="default">{t.legal.termsAIContentTitle}</TypographyH2>
					<TypographyP>{t.legal.termsAIContentText}</TypographyP>

					<TypographyH2 margin="default">{t.legal.termsPrivacyTitle}</TypographyH2>
					<TypographyP>
						{t.legal.termsPrivacyText}{" "}
						<TypographyLink href="/privacy">{t.legal.privacyTitle}</TypographyLink>
					</TypographyP>

					<TypographyH2 margin="default">{t.legal.termsLiabilityTitle}</TypographyH2>
					<TypographyP>{t.legal.termsLiabilityText}</TypographyP>

					<TypographyH2 margin="default">{t.legal.termsChangesTitle}</TypographyH2>
					<TypographyP>{t.legal.termsChangesText}</TypographyP>

					<TypographyH2 margin="default">{t.legal.termsContactTitle}</TypographyH2>
					<TypographyP>
